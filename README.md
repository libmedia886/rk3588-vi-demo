...
`MEDIA_VI_QuerySource` reads the current V4L2 format but may not report camera frame rate; this example explicitly falls back to 30 fps when `fps_milli` is zero.
